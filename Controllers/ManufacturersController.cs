...
namespace Product_Sales_Commision_MVC.Controllers
{
    public class ManufacturersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,BusinessName,Email")] Manufacturer manufacturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,BusinessName,Email")] Manufacturer manufacturer)
        {
